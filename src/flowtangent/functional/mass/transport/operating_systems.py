# flowtangent/Library/Methods/Mass/Correlation/Transport/operating_systems.py
...
def func_operating_systems(
    ...
    **kwargs,
    ...
    total_opsys_mass = jnp.sum(fixed_masses) + jnp.sum(per_seat_masses) * number_of_seats

    # Flight Control System Mass

    fc_scaler = (
        1.7  # 1.7 if Fully Aerodynamic
...
def operating_systems(
    ...
    results = func_operating_systems(
        fixed_array, per_seat_array, system.number_of_passengers, system.reference_area, s_tail
    )
