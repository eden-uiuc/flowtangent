...
def fM(
    ...
    f = lambda M1: (
        (
            M0
            / M1
            * ((1.0 + (g - 1.0) / 2.0 * M1**2) / (1.0 + (g - 1.0) / 2.0 * M0**2)) ** ((g + 1.0) / (2.0 * (g - 1.0)))
        )
        - AR
    )
...
def Rayleigh(
    ...
    f = lambda M1: (
        ((1.0 + g * M0**2) ** 2.0 * M1**2 * (1.0 + (g - 1.0) / 2.0 * M1**2))
        / ((1.0 + g * M1**2) ** 2.0 * M0**2 * (1.0 + (g - 1.0) / 2.0 * M0**2))
        - Tt_R
    )
    ...
    Pt_R = (
        (1.0 + g * M0**2)
        / (1.0 + g * M1**2)
        * ((1.0 + (g - 1.0) / 2.0 * M1**2) / (1.0 + (g - 1.0) / 2.0 * M0**2)) ** (g / (g - 1.0))
    )
