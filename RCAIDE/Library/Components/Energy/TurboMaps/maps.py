...
from RCAIDE.Library.Units import lbm, rev, mins, s
...
def AXI3_2():
     return CompressorMap(
        ...
        Wc_table=jnp.array([[[4.8430,   5.1909,  5.5289,  5.8564, 6.1729,   6.4780,  6.7714,  7.0525,  7.3212],
        ...
        eff_table=jnp.array([[[0.6673, 0.6982, 0.7210, 0.7340, 0.7349, 0.7208, 0.6849, 0.6177, 0.5090],
                             ...
                             [[0.6837, 0.7226, 0.7527, 0.7724, 0.7792, 0.7704, 0.7386, 0.6742, 0.5669],
                              ...
                              [0.8267, 0.8319, 0.8353, 0.8370, 0.8368, 0.8346, 0.8299, 0.8222, 0.8113],
                              [0.8180, 0.8199, 0.8209, 0.8208, 0.8197, 0.8176, 0.8141, 0.8091, 0.8024]]]),
        PR_table=jnp.array([[[1.2763, 1.2720, 1.2629, 1.2490, 1.2306, 1.2076, 1.1796, 1.1460, 1.1072],
