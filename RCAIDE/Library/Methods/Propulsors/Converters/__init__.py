...
from .combustor import func_combustor_performance

from .fan_compressor import func_fan_compressor_performance
...
from .turbine import func_turbine_performance